          ...
          <tbody>
            {history.map((bet) => (
              <tr key={bet.betId}>
                ...
                <td>
                  {parseInt(bet.closingPropertyValue._hex, 16) / 10 ** 18}
                </td>
                <td>
                  <Alert variant={bet.status === 2 ? "success" : "primary"}>
                    {bet.status === 2 ? "Completed" : "Open"}
                  </Alert>
                </td>
                <td className="col-1 text-truncate ">
                  {bet.userBid1.user.substring(0, 7)}...
                </td>
                <td className="col-1 text-truncate">
                  {bet.userBid2.user.substring(0, 7)}...
                </td>
